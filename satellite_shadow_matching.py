...
#
#     def process_epoch(self, satellite_data, initial_position, buildings, model):
#         """
...
#         building_meshes = visibility_calculator.preprocess_buildings(buildings,ref_alt)     #ecef坐标系下
#
#         #生成地面网格点
...
#
#         kml.save("F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\shadow_matching_improved2\\shadow_matching(P2)(unsmooth).kml")
#
...
#         "F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\satpos_new(P2).txt",
#         "F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\spp(P2).pos",
#         # "F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\spp(P2)_smoothed.csv",
#         "files\\buildings.txt",
#         "F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\shadow_matching_improved2\\shadow_matching(P2)(unsmooth).csv"
#     )