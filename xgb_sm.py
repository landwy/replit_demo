...
class SatelliteShadowMatching:
    ...
    def run(self, satellite_file, position_file, building_file, output_file):
        ...
        kml.save("F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\xgb-sm_yanshou_test_\\xgb-sm(P1).kml")
...
if __name__ == "__main__":
    ...
    sm_results = matcher.run(
        ...
        "files\\buildings.txt",
        "F:\\GNSSdata\Android GNSS data\\2025-04-15\\ALL\\xgb-sm_yanshou_test_\\xgb-sm(P1).csv"
    )